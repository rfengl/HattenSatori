...
class CustomTextField : UITextField, Required {
    override func initView() -> CustomTextField {
        ...
        self.backgroundColor = HattenColor.white.color
    ...
    func drawRightView() {
        if self.isEnabled {
            ...
            imageView.tintColor = HattenColor.gray700.color
    ...
    var isRequired: Bool {
        ...
        set {
            ...
            if mIsRequired {
                let placeholder = NSAttributedString(string: "This field is required", attributes: [NSForegroundColorAttributeName : HattenColor.primary.color])
