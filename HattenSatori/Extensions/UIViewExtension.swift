...
extension UIView
{
    ...
    func addBackground(image: UIImage) -> UIImageView {
    ...
    func startPulsing() {
        DispatchQueue.main.async(execute: {
            let pulsing = Pulsing(numberOfPulses: Float.infinity, radius: 49, position: self.center)
            pulsing.animationDuration = 2
            pulsing.backgroundColor = HattenColor.orange.color.cgColor
