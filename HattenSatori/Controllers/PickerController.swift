...
class PickerController: BaseTableController {
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = HattenColor.white.color
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        self.delegate.tableSelection(sender: self, tableView: tableView, section: indexPath.section, row: indexPath.row)
        self.close(sender: self)
    }
    
    @IBAction func clearText(_ sender: Any) {
        self.delegate.tableSelection(sender: self, tableView: tableView, section: nil, row: nil)
        self.close(sender: self)
    }
}
